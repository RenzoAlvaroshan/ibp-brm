...
func Seed(db *gorm.DB) {
	...
	tags := []Tag{
		{ID: uuid.New(), Name: "Enterprise",   Color: "#6366F1"},
		{ID: uuid.New(), Name: "Wholesale",    Color: "#10B981"},
		{ID: uuid.New(), Name: "Consumer",     Color: "#F59E0B"},
		{ID: uuid.New(), Name: "Connectivity", Color: "#3B82F6"},
		{ID: uuid.New(), Name: "Digital",      Color: "#EC4899"},
	}
	db.Create(&tags)
	...
	reqs := []Requirement{
		...
		},
		{
			...
			Status:      StatusRequirementGathering,
